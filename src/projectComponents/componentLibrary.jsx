...
const ComponentLibrary = React.memo(function ComponentLibrary(props) {
                ...
                {stackLogos.map((logo, index) => {
                    return (
                        <motion.div
                            ...
                            key={`project-${projectIndex}-stack-logo-comp-${index}`}
                        >
                            <motion.img
                                key={`${projectIndex}-tech-logo-component-${index}`}
                                src={logo}
                                alt='tech-stack'
